...
namespace PR4
{
    public partial class Buses : Form
    {
        ...
        delegate void AddBusDelegate1();
        delegate void UpdateBusInformationDelegate();
        private void AddBusDelegate()
        {
            AddBusDelegate1 addBusDelegate = AddBus;
            addBusDelegate();
        }
        ...
        private async void AddBus()
        {
                ...
                !string.IsNullOrEmpty(txt_RouteNumber.Text))
            {
                ...
                bus.Add(newBus);
                UpdateBusInformationDelegate updateBusInformationDelegate = UpdateBusInformation;
                updateBusInformationDelegate();
            }
